...
%%%%%%%%%LABERINTO MEDIANA DIFICULTAD NORMAL

map=im2bw(imread('laberinto_mediana.bmp')); % input map read from a bmp file. for new maps write the file name here

source=[20 350]; % source position in Y, X format
goal=[740 350]; % goal position in Y, X format
...
%%%%%LABERINTO DIFICULTAD MEDIANA AUMENTADO

% map=im2bw(imread('laberinto_mediana_aumentado.bmp')); % input map read from a bmp file. for new maps write the file name here
% 
% source=[41 700]; % source position in Y, X format
% goal=[1480 700]; % goal position in Y, X format
% 
% stepsize= 90; % size of each step of the RRT
